export default () => (
    <svg viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(-.5 6.5)">
            <path d="m18 26h16c1.108 0 2 0.892 2 2v16c0 1.108-0.892 2-2 2h-16c-1.108 0-2-0.892-2-2v-16c0-1.108 0.892-2 2-2z" filter="url(#c)" opacity=".15" stroke="#000" strokeLinejoin="round" stroke-opacity=".294" />
