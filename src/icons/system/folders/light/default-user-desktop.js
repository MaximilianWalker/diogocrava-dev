export default () => (
    <svg viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill-rule="evenodd">
            ...
            <path d="m15 50h34c0.554 0 0.75224 0.50449 1 1l1 2c0.24776 0.49551 0 1-1 1h-36c-1 0-1.2478-0.50449-1-1l1-2c0.24776-0.49551 0.446-1 1-1z" opacity=".15" style="paint-order:fill markers stroke" />
            <path d="m7 8c-1.662 0-3 1.338-3 3v3h56v-3c0-1.662-1.338-3-3-3z" fill="#808080" style="paint-order:fill markers stroke" />
            <g transform="translate(1.9954)" fill="#808080">
            ...
            <path d="m4 52.062v0.9375c0 1.662 1.338 3 3 3h50c1.662 0 3-1.338 3-3v-0.9375c0 1.6274-1.338 2.9375-3 2.9375h-50c-1.662 0-3-1.3101-3-2.9375z" opacity=".1" style="paint-order:fill markers stroke" />
        </g>
        <rect x="7" y="56" width="50" height="5" ry="0" fill="url(#b)" opacity=".15" stroke-width="1.4088" />
    </svg>
);